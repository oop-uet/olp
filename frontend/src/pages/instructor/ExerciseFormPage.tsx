  ...
  return (
    <div className="mx-auto max-w-[1680px] space-y-5 px-2 pb-8 sm:px-4">
      ...
      >
          ...
          <section className="flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-slate-50/80 shadow-sm xl:col-span-7">
            <div className="flex flex-wrap items-center justify-between gap-3 border-b border-slate-200 bg-white px-4 py-3">
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                />
                <button type="button" onClick={handleDownloadBlankTemplate} className="btn-secondary btn-sm h-8 text-xs font-semibold">
                  Tải mẫu JSON
                </button>
        ...
        {/* OOP Tags */}
        <div className="xl:col-span-12 rounded-xl border border-slate-200 bg-slate-50/70 p-4">
          <label className="label text-slate-800 font-bold">
            Thẻ OOP (Object-Oriented Programming Tags) <span className="text-danger-500">*</span>
            <span className="ml-1 font-normal text-slate-500">(chọn 1-5 thẻ)</span>
          </label>
                ...
                <button
                  ...
                  className={`rounded-full border px-3.5 py-1.5 text-xs font-semibold transition-all ${
                    isSelected
                      ...
                      : 'border-slate-300 bg-white text-slate-700 hover:border-primary-300 hover:bg-primary-50/50'
                  }`}
                >
                  {tag}
                </button>
          ...
          {errors.tags && <p className="mt-1.5 text-xs text-danger-600 font-semibold">{errors.tags}</p>}
        </div>
