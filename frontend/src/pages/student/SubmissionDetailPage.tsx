        ...
        <main className="min-w-0 overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm flex flex-col h-[680px]">
          ...
          <div className="border-b border-slate-100 bg-slate-50/50 px-5 py-3 flex flex-wrap gap-4 text-xs font-semibold text-slate-500">
            <label className="flex items-center gap-1.5 cursor-not-allowed">
              <input type="checkbox" checked={submission.score === 0 && review.results.some(r => r.status === 'error')} disabled className="rounded text-primary focus:ring-primary h-3.5 w-3.5" />
            ...
            <label className="flex items-center gap-1.5 cursor-not-allowed">
              <input type="checkbox" checked={review.results.length > 0 && review.results.every(r => r.status === 'error')} disabled className="rounded text-primary focus:ring-primary h-3.5 w-3.5" />
