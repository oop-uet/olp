...
const exerciseSeeds: ExerciseSeed[] = [
  ...
  {
    title: "Student Class Creation",
    description:
      "Create a `Student` class with private fields: `name` (String), `studentId` (String), and `gpa` (double). " +
      "Implement a constructor that accepts all three fields, getter methods for each field, " +
      "and a `toString()` method that returns the format: `Student[name=<name>, id=<studentId>, gpa=<gpa>]`. " +
      "The GPA must be between 0.0 and 4.0; throw IllegalArgumentException if invalid.",
    difficulty: "easy",
    ...
    testCasesData: [
      { inputData: "Alice 22001234 3.8", expectedOutput: "Student[name=Alice, id=22001234, gpa=3.8]", isVisible: 1, pointValue: 30 },
      { inputData: "Bob 22005678 0.0", expectedOutput: "Student[name=Bob, id=22005678, gpa=0.0]", isVisible: 1, pointValue: 30 },
      { inputData: "Charlie 22009999 4.0", expectedOutput: "Student[name=Charlie, id=22009999, gpa=4.0]", isVisible: 0, pointValue: 20 },
      { inputData: "Dave 22001111 -1.0", expectedOutput: "IllegalArgumentException", isVisible: 0, pointValue: 20 },
    ],
  },
  {
